...
public class ManTimeOffRequestList extends JFrame implements ActionListener, MouseListener
{
            ...
            if (col == 0) 
            {
                ...
                if (rowData != null) 
                {
                    ...
                    employee.setStatus(rowData.get(19).toString());
                            ...
                            ManTimeOff timeOffForm = new ManTimeOff(employee);
